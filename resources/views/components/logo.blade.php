<svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1" viewBox="0 0 512 512" xml:space="preserve" {{ $attributes }}>
    <defs />
    <style>
        .st0 {
            fill: #1b3954
